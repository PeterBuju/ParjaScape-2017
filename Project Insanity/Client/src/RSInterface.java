...
public final class RSInterface {
    ...
    /*public static void grandExchangeBuyTab(TextDrawingArea[] tda) {
        ...
        // Item Amount
        addButton(7501, 0, "/GrandExchange/Sprites/AddOne", "Add one");
        addButton(7502, 0, "/GrandExchange/Sprites/AddTen", "Add ten");
        addButton(7503, 0, "/GrandExchange/Sprites/AddHundered", "Add one hundred");
        addButton(7504, 0, "/GrandExchange/Sprites/AddThousand", "Add one thousand");
        addButton(7505, 0, "/GrandExchange/Sprites/IncreaseOne", "Add one");
        addButton(7506, 0, "/GrandExchange/Sprites/DecreaseOne", "Remove one");
        
        // Item Price
        addButton(7507, 0, "/GrandExchange/Sprites/AddOne", "Add one");
        addButton(7508, 0, "/GrandExchange/Sprites/AddTen", "Add ten");
        addButton(7509, 0, "/GrandExchange/Sprites/AddHundered", "Add one hundred");
        addButton(7510, 0, "/GrandExchange/Sprites/EditQuantity", "Edit Quantity");
        addButton(7511, 0, "/GrandExchange/Sprites/IncreaseOne", "Add one");
        addButton(7512, 0, "/GrandExchange/Sprites/DecreaseOne", "Remove one");
       
        // Background Bar for displaying text
        addSprite(7513, 0, "/GrandExchange/Sprites/QuanityBar");
        
        // Item Searching
        addButton(7514, 0, "/GrandExchange/Sprites/Search", "Search for item");
        
        // Text
        addText(7515,"Price Per Item", tda, 1, 0xff9933, true, true);
        addText(7516,"Amount being sold", tda, 1, 0xff9933, true, true);
        addText(7517,"Item being sold", tda, 1, 0xff9933, true, true);
        addText(7518,"0 GP", tda, 1, 0xB58338, true, true);
        addText(7519,"0", tda, 1, 0xB58338, true, true);
        addText(7520,"None Selected", tda, 1, 0xB58338, true, true);
        addText(7523,"Sell Item", tda, 1, 0xff9933, true, true);
        addText(7524,"Go Back", tda, 1, 0xff9933, true, true);
        // Complete Butttons
        addButton(7521, 0, "/GrandExchange/Sprites/Sell", "Sell Item");
        addButton(7522, 0, "/GrandExchange/Sprites/Buy", "Go Back");
        
        tab.totalChildren(24);
        // Item Amount
        tab.child(0, 7513, 35, 150);
        tab.child(1, 7506, 15, 154);
        tab.child(2, 7505, 165, 154);
        tab.child(3, 7501, 15, 180);
        tab.child(4, 7502, 57, 180);
        tab.child(5, 7503, 98, 180);
        tab.child(6, 7504, 140, 180);
        tab.child(7, 7516, 97, 133);
        tab.child(19, 7519, 97, 152);
        // Item Price
        tab.child(8, 7513, 35, 70);
        tab.child(9, 7512, 15, 74);
        tab.child(10, 7511, 165, 74);
        tab.child(11, 7507, 15, 100);
        tab.child(12, 7508, 57, 100);
        tab.child(13, 7509, 98, 100);
        tab.child(14, 7510, 140, 100);
        tab.child(15, 7515, 97, 53);
        tab.child(20, 7518, 97, 72);
        // Item Info
        tab.child(16, 7513, 60, 20);
        tab.child(17, 7517, 122, 3);
        tab.child(18, 7514, 10, 10);
        tab.child(21, 7520, 115, 22);
        // End Buttons
        tab.child(22, 7521, 30, 210);
        tab.child(23, 7522, 110, 210);
	...
	public static void unpack(StreamLoader streamLoader, TextDrawingArea textDrawingAreas[], StreamLoader streamLoader_1) {
		...
		aClass44 = streamLoader;
                //grandExchangeBuyTab(textDrawingAreas);
	...
	public static void constructLunar(){
        ...
        // Skill bonus interface
        public static void skillBonusTab(TextDrawingArea[] tda) {
            //RSInterface tab = addTabInterface(30316);
            //addSprite(32001, 1, "/Skill Bonus/bk");

            RSInterface RSinterface = addInterface(30316);
            addText(30317, "What", 0x999999, false, true, 52, tda, 1);
            addText(30318, "What", 0x33cc00, false, true, 52, tda, 1);
            addText(30319, "(Need 5 to 25 players)", 0xFFcc33, false, true, 52, tda, 1);
            addText(30320, "Points", 0x33ccff, false, true, 52, tda, 1);
            int last = 4;
            RSinterface.children = new int[last];
            RSinterface.childX = new int[last];
            RSinterface.childY = new int[last];
            setBounds(30321, 15, 12, 0, RSinterface);
            setBounds(30322, 15, 30, 1, RSinterface);
            setBounds(30323, 15, 48, 2, RSinterface);
            setBounds(30324, 15, 66, 3, RSinterface);
        }
