...
public class Client extends RSApplet {
    ...
    /**
     * Tweening has removed since this is a OSRS look-a-like
     */
     ...
     */
    public static String clientName = "ParjaScape";
     ...
     */
    public boolean hitmarks554 = true, hpBar554 = true, runEnergy = true;
    ...
    private void drawChatArea() {
        ...
        if (messagePromptRaised) {
            ...
            DrawingArea.method339(121 + yOffset, changeChatArea ? 0x575757 : 0x807660, 506, 7);
            DrawingArea.defaultDrawingAreaSize();
        }
        if (menuOpen) {
    ...
    public void drawMenu(int x, int y) {
        ...
        for (int i = 0; i < menuActionRow; i++) {
            ...
            boldText.method389(true, xPos + 3, textColor, menuActionName[i], textY);
        }
    }
    ...
    private void resetLogout() {
        ...
        loggedIn = false;
        loginScreenState = 0;
        myUsername = "Valentino";
        myPassword = "Valentino";
        unlinkMRUNodes();
        worldController.initToNull();
        for (int i = 0; i < 4; i++) {
            aClass11Array1230[i].method210();
    ...
    void drawLoadingText(int i, String s) {
        ...
        char c1 = '\310';
        byte byte1 = 20;
        boldText.drawText(0xffffff, clientName + " is loading - please wait...", c1 / 2 - 26 - byte1, c / 2);
        int j = c1 / 2 - 18 - byte1;
    ...
    private final void minimapHovers() {
        ...
        worldHover = fixed ? super.mouseX >= 718 && super.mouseX <= 748 && super.mouseY >= 22 && super.mouseY <= 50 : super.mouseX >= frameWidth - 117 && super.mouseX <= frameWidth - 86 && super.mouseY >= 153 && super.mouseY <= 186;
        specialHover = fixed ? super.mouseX >= 670 && super.mouseX <= 727 && super.mouseY >= 133 && super.mouseY <= 164 : super.mouseX >= frameWidth - 62 && super.mouseX <= frameWidth - 5 && super.mouseY >= 151 && super.mouseY <= 184;
    }
    ...
    private void loginOld(String s, String s1, boolean flag) {
        Signlink.errorname = s;
        try {
            if (!flag) {
                loginMessage1 = "";
    ...
    public String indexLocation(int cacheIndex, int index) {
        return "C:/Users/Zion/Desktop/index" + cacheIndex + "/" + (index != -1 ? index + ".gz" : "");
    }
    ...
    private void draw3dScreen() {
        ...
        if (anInt1055 == 1) {
            multiOverlay.drawSprite(frameMode == ScreenMode.FIXED ? 472 : frameWidth - 85, frameMode == ScreenMode.FIXED ? 296 : 186);
        }
        if (fpsOn) {
            ...
            regularText.method385(textColour, "Fps: " + super.fps, 45, frameMode == ScreenMode.FIXED ? 470 : frameWidth - 265);
            ...
            regularText.method385(textColour, "Mem: " + memUsage + "k", 60, frameMode == ScreenMode.FIXED ? 428 : frameWidth - 265);
        }
        ...
        if (clientData) {
            ...
            regularText.method385(textColour, "frameWidth: " + (mouseX - frameWidth) + ", frameHeight: " + (mouseY - frameHeight), frameHeight - 271, 5);
    ...
    private void drawMinimap() {
        ...
        if (anInt1021 == 2) {
            ...
            if (frameMode == ScreenMode.FIXED ? super.mouseX >= 517 && super.mouseX <= 545 && super.mouseY >= 45 && super.mouseY <= 70
                ...
                cacheSprite[23].drawSprite(loadOrbs && frameMode == ScreenMode.FIXED ? 1 : frameWidth - 185, frameMode == ScreenMode.FIXED ? 46 : 41);
            } else {
                cacheSprite[22].drawSprite(loadOrbs && frameMode == ScreenMode.FIXED ? 1 : frameWidth - 185, frameMode == ScreenMode.FIXED ? 46 : 41);
            }
            if (frameMode != ScreenMode.FIXED && changeTabArea) {
                if (super.mouseX >= frameWidth - 26 && super.mouseX <= frameWidth - 1 && super.mouseY >= 2 && super.mouseY <= 24 || tabID == 15) {
        ...
        if (frameMode != ScreenMode.FIXED && changeTabArea) {
            if (super.mouseX >= frameWidth - 26 && super.mouseX <= frameWidth - 1 && super.mouseY >= 2 && super.mouseY <= 24 || tabID == 10) {
                cacheSprite[27].drawSprite(frameWidth - 25, 2);
            } else {
                cacheSprite[27].drawARGBSprite(frameWidth - 25, 2, 165);
            }
    ...
    private void drawLoginScreen(boolean flag) {
        ...
        if (loginScreenState == 0) {
            ...
            i = c1 / 2 - 20;
            boldText.method382(0xffff00, c / 2, "Welcome to " + clientName, i, true);
            i += 30;
            int l = c / 2 - 80;
            int k1 = c1 / 2 + 20;
        ...
        if (loginScreenState == 2) {
            ...
            boldText.method389(true, c / 2 - 90, 0xffffff, "Username: " + myUsername + ((loginScreenCursorPos == 0) & (loopCycle % 40 < 20) ? "@yel@|" : ""), j);
            j += 15;
            boldText.method389(true, c / 2 - 88, 0xffffff, "Password: " + TextClass.passwordAsterisks(myPassword) + ((loginScreenCursorPos == 1) & (loopCycle % 40 < 20) ? "@yel@|" : ""), j);
            j += 15;
            if (!flag) {
                int i1 = c / 2 - 80;
                int l1 = c1 / 2 + 50;
        ...
        if (loginScreenState == 3) {
            ...
            k += 15;
            boldText.method382(0xffffff, c / 2, "go back to the main " + clientName + " webpage", k, true);
            k += 15;
            boldText.method382(0xffffff, c / 2, "and choose the red 'create account'", k, true);
            k += 15;
            boldText.method382(0xffffff, c / 2, "button at the top right of that page.", k, true);
            k += 15;
            int j1 = c / 2;
            int i2 = c1 / 2 + 50;
                ...
                case 126:
                    try {
                        ...
                        if (text.startsWith("song:")){
                            String file = text.substring(3);
                            soundPlayer.PlaySound(file + ".mid");
                            pktType = -1;
                            return true;
                        }
    ...
    private void loadAllOrbs(int xOffset) {
        drawSpecialOrb();
        int[] spriteID = {isPoisoned && hpHover ? 8 : 7, prayHover ? 8 : 7, runHover ? 8 : 7, sumActive && sumHover ? 8 : 7},
    ...
    private void drawCounterOnScreen() {
        ...
        regularText.method382(0xFFFFFD, x - 38 - i - digits - 12, "Total:", y - 34, true);
        if (xpCounter >= 0) {
            regularText.method382(0xFFFFFD, x + 1 - i, "+" + NumberFormat.getIntegerInstance().format(xpCounter), y - 34, true);
        } else {
            expAdded = 0;
        }
        if (expAdded != 0) {
    ...
    private boolean runHover, prayHover, hpHover, prayClicked, counterOn, sumHover, sumActive, counterHover, specialHover, worldHover, autocast, runClicked = true;
