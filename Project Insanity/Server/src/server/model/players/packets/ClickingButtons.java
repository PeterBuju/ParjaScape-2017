...
public class ClickingButtons implements PacketType {
    ...
    public void processPacket(Client c, int packetType, int packetSize) {
        ...
        switch (actionButtonId) {
            ...
            case 53149:
                int 
                i = c.getItems().getItemAmount(c.currentRecipe.preCookedId);
                c.cookAmount = i;
                c.getCooking().setupCooking();
                break;
            //1st tele option
            ...
            case 28164: // item kept on death 
                ...
                c.sendMessage("Opened interface 32000");
                break;
            ...
            case 152:
                ...
                c.getPA().sendFrame36(173, c.isRunning ? 0 : 1);
                break;
 ...
 /* Player Options */
            ...
            case 47130:
                c.forcedText = "I must slay another " + c.taskAmount + " " + Server.npcHandler.getDBNpcName(c.slayerTask) + ".";
