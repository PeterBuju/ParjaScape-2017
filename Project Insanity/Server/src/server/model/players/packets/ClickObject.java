...
public class ClickObject implements PacketType {
        ...
        public static class Animations{
            public static int LadderUp = 828;
            public static int LadderDown = 9727;
        }
		...
		switch(packetType) {
			...
			c.objectDistance = 1;
                        ...
                        if (c.goodDistance(c.getX(), c.getY(), c.objectX, c.objectY, 1)){
                            ...
                            //SPECIAL CASE DOOR
                            if (c.objectId == 1513 && c.absY == 4684)
                            {
                                if (c.absX == 2638 && c.tutorial > 0){//TELE LEFT
                                    if (Config.SERVER_DEBUG)
                                        c.sendMessage("Tele left");
                                    c.getPA().movePlayer(c.absX - 1, c.absY, c.heightLevel);
                                }
                                if (c.absX == 2637 && c.tutorial > 0){//TELE RIGHT
                                    if (Config.SERVER_DEBUG)
                                        c.sendMessage("Tele right");
                                    c.getPA().movePlayer(c.absX + 1, c.absY, c.heightLevel);
                                }
                            }
                            //END SPECIAL CASE DOOR
                            //LADDER
                            ...
                            //STAIRCASE GOING UP
                            if (c.objectId == 1730 || c.objectId == 1738){
                                c.getPA().movePlayer(c.absX, c.absY, c.heightLevel + 1);
                            }
                            ...
                            //STAIRCASE GOING UP + MODIFY Y 
                            if (c.objectId == 1723){
                                c.getPA().movePlayer(c.absX, c.absY - 4, c.heightLevel - 1);                           
                            }                 
                            
                            //STAIRCASE GOING DOWN + MODIFY Y
                            if (c.objectId == 1722){
                                c.getPA().movePlayer(c.absX, c.absY + 4, c.heightLevel + 1);
                            }                   
                        }
