		...
		while(EndOfFile == false && line != null) {
			...
			if (spot > -1) {
				...
				if (line.equals("[ACCOUNT]")) {                 ReadMode = 1;
                                } else if (line.equals("[STATS]")) {            ReadMode = 2;
                                } else if (line.equals("[PERKS]")) {            ReadMode = 3;
                                } else if (line.equals("[CHARACTER]")) {	ReadMode = 4;
				} else if (line.equals("[EQUIPMENT]")) {	ReadMode = 5;
				} else if (line.equals("[LOOK]")) {		ReadMode = 6;
				} else if (line.equals("[SKILLS]")) {		ReadMode = 7;
				} else if (line.equals("[ITEMS]")) {		ReadMode = 8;
				} else if (line.equals("[BANK]")) {		ReadMode = 9;
				} else if (line.equals("[FRIENDS]")) {		ReadMode = 10;
				} else if (line.equals("[IGNORES]")) {		ReadMode = 11;
