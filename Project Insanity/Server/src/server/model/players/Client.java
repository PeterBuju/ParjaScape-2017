...
public class Client extends Player {
    ...
    public int[] oldLocation = new int[3];
    
    private HouseBackup house;
    ...
    public void frame174(int id, int volume, int delay)//This allows you to play sounds
    {
...
//sM("Frame 174 tested");
    ...
    public void frame74(int i1, int i2, int i3) {
        outStream.createFrame(174);
    ...
    public void playMusic(String file){
        getPA().sendFrame126("song:" + file, 1);
        flushOutStream();
    }
    ...
    public void clearQuestsTab() {
        ...
        getPA().sendFrame126("Hello World!", 29155);*/
    }
    ...
    public void logout() {
        synchronized (this) {
            if (System.currentTimeMillis() - logoutDelay > 10000) {
                ...
                properLogout = true;
                if (inHouse)
                    getPA().movePlayer(oldLocation[0], oldLocation[1], oldLocation[2]);
            } else {
    ...
    public void process() {
        ...
        if (wcTimer > 0 && woodcut[0] > 0) {
            ...
            getFishing().Fish();
        } else if (cookingTimer == 0 && isCooking && currentRecipe != null){
            getCooking().Cook();
        } else if (cookingTimer > 0 && isCooking){
            cookingTimer--;
        }
    ...
    public HouseBackup getHouse(){
       return house; 
    }
    
    public void setHouse(HouseBackup house){
        this.house = house;
    }
}
