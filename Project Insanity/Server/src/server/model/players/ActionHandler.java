...
public class ActionHandler {
    ...
    public void firstClickObject(int objectType, int obX, int obY) {
        ...
        // Debug
        c.sendMessage("Object: " + c.objectId + "X: " + c.objectX + "Y: " + c.objectY);
    }
    ...
    public void firstClickNpc(int npcType, String description) {
        c.clickNpcType = 0;
        c.npcClickIndex = 0;
        switch (npcType) {
            case 949:
            ...
            case 946:
                if (c.tutorial >= 5) {
                    ...
                    c.sendMessage("Use the portal now, to go mainland!.");
                }
                break;
            ...
            case 944:
                if (c.tutorial == 7) {
                    ...
                    if (c.getItems().playerHasItem(2134, 1)) {
                        c.getDH().sendDialogues(125, npcType);
                        c.getItems().deleteItem(2134, 1);
                        c.tutorial = 9;
                    } else {
                        c.sendMessage("You need to get 1 piece of rat meat and have them in your inventory to continue!");
                    }
                }
                break;
            ...
            case 942:
                if (c.tutorial == 2) {
                    ...
                    if (c.getItems().playerHasItem(2309, 1)) {
                        c.getDH().sendDialogues(138, npcType);
            ...
            case 904:
                ...
                break;
            case 720:   //SpawnPoint Recruiter
                if (description.equalsIgnoreCase("spawnpoint_recruiter")) {
