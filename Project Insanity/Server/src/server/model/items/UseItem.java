...
public class UseItem {
    ...
    public static void ItemonObject(Client c, int objectID, int objectX, int objectY, int itemId) {
        ...
        //c.forcedChat("Item: " + itemId + "Object: " + objectID);
        switch (objectID) {
            case 2783:
            ...
            case 2732:
            case 4266:
                c.getPA().viewCookInterface(itemId);
                c.currentRecipe = RecipeManager.GetRecipe(itemId);
                c.cookAmount = 0;
                c.cookingOn = objectID;
        ...
        switch (itemUsed) {
            ...
            case 1929:
                if (c.getItems().playerHasItem(1933, 1)) {
                    ...
                    c.sendMessage("Click 'use' in the range now.");
                }
                break;
            case 1933:
