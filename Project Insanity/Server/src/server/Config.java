...
public class Config {
	...
	public static boolean SERVER_DEBUG = true;//needs to be false for Real world to work
	
	public static final String SERVER_NAME = "Project Insanity";
	public static final String WELCOME_MESSAGE = "Download the new client @ www.project-insanity.tk";
	...
	public static final int[] FUN_WEAPONS	=	{2460,2461,2462,2463,2464,2465,2466,2467,2468,2469,2470,2471,2471,2473,2474,2475,2476,2477}; // fun weapons for dueling
        ...
        public static final double BUYMODIFIER = 1.15;
        public static final double SELLMODIFIER = 0.85;
	...
	public static final int RANDOM_DUELING_RESPAWN = 5; // random coords
        ...
        //STAT MULTIPLIERS
        public static final int WISDOM_MULTIPLIER = 1;
        public static final int CONSTITUTION_MULTIPLIER = 1;
        public static final int SPEED_MULTIPLIER = 1;
        public static final int DEXTERITY_MULTIPLIER = 1;
        public static final int ENDURANCE_MULTIPLIER = 1;
	...
	*/	
	public static final int WOODCUTTING_EXPERIENCE = 3;
	public static final int MINING_EXPERIENCE = 3;
	public static final int SMITHING_EXPERIENCE = 3;
	public static final int FARMING_EXPERIENCE = 5;
	public static final int FIREMAKING_EXPERIENCE = 1;
	public static final int HERBLORE_EXPERIENCE = 5;
	public static final int FISHING_EXPERIENCE = 5;
	...
	public static final int COOKING_EXPERIENCE = 5;
